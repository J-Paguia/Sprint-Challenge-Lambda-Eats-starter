...
Validation is a process of checking the code for errors, future proofing your work, and learning tool.

3. In 1-2 sentences, define end to end testing.

End to End Testing, or UI testing is one the many approaches for testing a web application. An end to end test is supposed to check whether a web application works as expected or not.
